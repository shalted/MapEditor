...
Shader "SW_Lit"
{
	Properties
	{
		...
		[ASEBegin]_Albedo("主帖图", 2D) = "white" {}
		_Color("主颜色", Color) = (1,1,1,1)
		[NoScaleOffset][Normal]_BumpMap("法线图", 2D) = "bump" {}
		_NormalScale("法线强度", Range( 0.5 , 2)) = 1
		[NoScaleOffset]_Mask("R:光滑度 G:金属度 B:环境光 A:自发光", 2D) = "white" {}
		_Smoothness("光滑度", Range( 0 , 1)) = 0.5
		_Metallic("金属度", Range( 0 , 1)) = 0.5
		_Occlusion("环境光强度", Range( 0 , 1)) = 1
		[HDR]_EmissionColor("自发光颜色", Color) = (0,0,0,0)
		_RimRange("边缘光范围", Range( 0 , 2)) = 0
		_RimBias("边缘光偏移", Range( 0 , 1)) = 0
		[ASEEnd][HDR]_RimColor("边缘光颜色", Color) = (1,1,1,1)
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 unpack20 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, uv_Albedo ), _NormalScale );
				unpack20.z = lerp( 1, unpack20.z, saturate(_NormalScale) );
				
				float fresnelNdotV31 = dot( WorldNormal, WorldViewDirection );
				float fresnelNode31 = ( _RimBias + _RimRange * Pow5( 1.0 - fresnelNdotV31) );
				float4 break16 = SAMPLE_TEXTURE2D( _Mask, sampler_Mask, uv_Albedo );
				

				float3 BaseColor = ( SAMPLE_TEXTURE2D( _Albedo, sampler_Albedo, uv_Albedo ) * _Color ).rgb;
				float3 Normal = unpack20;
				float3 Emission = ( ( fresnelNode31 * _RimColor ) + ( break16.a * _EmissionColor ) ).rgb;
				float3 Specular = 0.5;
				float Metallic = ( break16.g * _Metallic );
				float Smoothness = ( break16.r * _Smoothness );
				float Occlusion = ( break16.b * _Occlusion );
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float fresnelNode31 = ( _RimBias + _RimRange * pow( 1.0 - fresnelNdotV31, 5.0 ) );
				float4 break16 = SAMPLE_TEXTURE2D( _Mask, sampler_Mask, uv_Albedo );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;366,36;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;SW_Lit;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;0;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;41;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;638761580371289720;Built-in Fog;1;638761580387188753;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;False;True;False;False;False;False;;True;0
Node;AmplifyShaderEditor.BreakToComponentsNode;16;17,-111.5;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;140,159.5;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;143,273.5;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;141,51.5;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;11;-693,-202.5;Inherit;False;0;10;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;-25,396.5;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;10;-400,-399.5;Inherit;True;Property;_Albedo;主帖图;0;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;15;-336,-69.5;Inherit;True;Property;_Mask;R:光滑度 G:金属度 B:环境光 A:自发光;4;1;[NoScaleOffset];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;21;-248,-203.5;Inherit;False;Property;_NormalScale;法线强度;3;0;Create;False;0;0;0;False;0;False;1;0;0.5;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-559,87.5;Inherit;False;Property;_Smoothness;光滑度;5;0;Create;False;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-558,181.5;Inherit;False;Property;_Metallic;金属度;6;0;Create;False;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-533,287.5;Inherit;False;Property;_Occlusion;环境光强度;7;0;Create;False;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;24;-338,388.5;Inherit;False;Property;_Color;主颜色;1;0;Create;False;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;29;449.8813,-142.4238;Inherit;False;Property;_RimColor;边缘光颜色;11;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;23;-84,568.5;Inherit;False;Property;_EmissionColor;自发光颜色;8;1;[HDR];Create;False;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;30;305.8813,533.5762;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;20;-13,-407.5;Inherit;True;Property;_BumpMap;法线图;2;2;[NoScaleOffset];[Normal];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;919.8813,6.576172;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;177.8259,499.793;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FresnelNode;31;554.8813,-382.4238;Inherit;True;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;38;294.3043,-358.2824;Inherit;False;Property;_RimBias;边缘光偏移;10;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;37;286.3043,-263.2824;Inherit;False;Property;_RimRange;边缘光范围;9;0;Create;False;0;0;0;False;0;False;0;0;0;2;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=F3C0A5C4C0D0E2D2F9ADE5F6BF77F0732279FA0B