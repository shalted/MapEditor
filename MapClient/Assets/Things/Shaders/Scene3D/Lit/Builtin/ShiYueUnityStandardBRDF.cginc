#ifndef SHIYUWUNITYSTANDARDBRDF
#define SHIYUWUNITYSTANDARDBRDF
    ...
    UnityLight light, UnityIndirect gi)
{
    // Custom Light
#if LIGHTMAP_ON
    light.dir = _RunTimeLightDir;
    light.color = _RunTimeLightColor;
#endif
...
half3 BRDF3_Direct_Custom(half3 diffColor, half3 specColor, half rlPow4, half smoothness)
{
...
half3 BRDF3_Indirect_Custom(half3 diffColor, half3 specColor, UnityIndirect indirect, half grazingTerm, half fresnelTerm)
{
