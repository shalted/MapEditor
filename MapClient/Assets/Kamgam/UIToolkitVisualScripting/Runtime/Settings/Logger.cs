...
namespace Kamgam.UIToolkitVisualScripting
{
    public class Logger
    {
        ...
        public const string Prefix = "UITK VisualScripting: ";
		...
		const string changeHint = "\nYou can change the verbosity of logs in the Settings under Tools > UI Toolkit Visual Scripting > Settings : LogLevel";
