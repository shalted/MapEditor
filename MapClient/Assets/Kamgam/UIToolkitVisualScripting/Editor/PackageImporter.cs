...
namespace Kamgam.UIToolkitVisualScripting
{
    public static class PackageImporter
    {
        ...
        {
			new Package( PackageType.Playmaker,  "Assets/Kamgam/UIToolkitVisualScripting/Packages/UIToolkitVisualScriptingPlaymaker.unitypackage" )
        };
        ...
        const string PackagesToImportKey = "Kamgam.UIToolkitVisualScripting.PackagesToImport";

        [MenuItem("Tools/UI Toolkit Visual Scripting/Debug/Import packages", priority = 500)]
        ...
        static List<PackageType> initializePackagesToImport()
        {
            ...
            addPlaymakerPackageIfNeeded(packages);
        ...
        static void addPlaymakerPackageIfNeeded(List<PackageType> packages)
        {
            /*
             * TODO
            if (false)
            {
                Debug.Log("PackageImporter: Playmaker detected. Adding playmake package to import list.");
            }
            */
        }
