...
namespace UnityEngine.UI
{
    ...
    public class Image : MaskableGraphic, ISerializationCallbackReceiver, ILayoutElement, ICanvasRaycastFilter
    {
		...
		void GenerateMirrorSprite (VertexHelper toFill){
            ...
            {
                case Rotation.None:
                    AddQuad(toFill,  rect.position, new Vector2(rect.width, rect.height) + rect.position, color, new Vector2(uv.x,uv.y), new Vector2(uv.z,uv.w));
                    break;
                case Rotation.Rotation90:
                    AddQuad(toFill,  rect.position, new Vector2(rect.width/2, rect.height) + rect.position, color, new Vector2(uv.x,uv.y), new Vector2(uv.z,uv.w));
                    AddQuad(toFill,  new Vector2(rect.width/2, 0) + rect.position, new Vector2(rect.width, rect.height) + rect.position, color, new Vector2(uv.z,uv.y), new Vector2(uv.x,uv.w));
                    break;
                case Rotation.Rotation180:
                    AddQuad(toFill,  rect.position + new Vector2(0, rect.height/2) , new Vector2(rect.width, rect.height) + rect.position, color, new Vector2(uv.x,uv.y), new Vector2(uv.z,uv.w));
                    AddQuad(toFill,  rect.position , new Vector2(rect.width, rect.height/2) + rect.position, color, new Vector2(uv.x,uv.w), new Vector2(uv.z,uv.y));
                    break;
                case Rotation.Rotation270:
                    AddQuad(toFill,  new Vector2(0, rect.height/2) + rect.position, new Vector2(rect.width/2, rect.height) + rect.position, color, new Vector2(uv.x,uv.y), new Vector2(uv.z,uv.w));
                    AddQuad(toFill,  new Vector2(rect.width/2, rect.height/2) + rect.position, new Vector2(rect.width, rect.height) + rect.position, color, new Vector2(uv.z,uv.y), new Vector2(uv.x,uv.w));
                    AddQuad(toFill,  rect.position , new Vector2(rect.width/2, rect.height/2) + rect.position, color, new Vector2(uv.x,uv.w), new Vector2(uv.z,uv.y));
                    AddQuad(toFill,  new Vector2(rect.width/2, 0) + rect.position , new Vector2(rect.width, rect.height/2) + rect.position, color, new Vector2(uv.z,uv.w), new Vector2(uv.x,uv.y));
                    break;
                case Rotation.FlipHorizontal:
                    AddQuad(toFill,  rect.position, new Vector2(rect.width/2, rect.height) + rect.position, color, new Vector2(uv.x,uv.y), new Vector2(uv.z,uv.w));
                    AddQuad(toFill,  new Vector2(rect.width/2, 0) + rect.position, new Vector2(rect.width, rect.height) + rect.position, color, new Vector2(uv.z,uv.y), new Vector2(uv.x,uv.w));
