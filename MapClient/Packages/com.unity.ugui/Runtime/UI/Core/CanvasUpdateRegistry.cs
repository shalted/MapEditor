...
namespace UnityEngine.UI
{
    ...
    public class CanvasUpdateRegistry
    {
        ...
        private int m_LayerUI;

        protected CanvasUpdateRegistry()
        {
            m_LayerUI = LayerMask.NameToLayer("UI");
            currentCamera = null;
        ...
        {
            //性能优化：屏蔽由于Camera.Render()触发willRenderCanvases
            if(currentCamera != null && (currentCamera.cullingMask & 1 << m_LayerUI) == 0) {
                return;
            }
            //
