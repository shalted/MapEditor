...
namespace UnityEngine.UI
{
          ...
          ICanvasElement
    {
        ...
        static public Material defaultGraphicMaterial
        {
            ...
            {
                if (s_DefaultUI == null)
                    s_DefaultUI = Resources.Load<Material>("DefaultMaterials/UI-Default");
                if (s_DefaultUI == null)
        ...
        [SerializeField] protected bool m_Grey = false;
        ...
        public bool grey
        {
            ...
            set
            {
                if (SetPropertyUtility.SetStruct(ref m_Grey, value))
                {
                    SetVerticesDirty();
                }
            }
