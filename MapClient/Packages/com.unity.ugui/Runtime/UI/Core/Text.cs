...
namespace UnityEngine.UI
{
    ...
    public class Text : MaskableGraphic, ILayoutElement, ISerializationCallbackReceiver
    {
        ...
        {
            get { return m_TextCache ?? (m_TextCache = new TextGenerator(Mathf.Max(m_Text != null ? m_Text.Length : 0, 0))); }
        }
        ...
        {
            get { return m_TextCacheForLayout ?? (m_TextCacheForLayout = new TextGenerator(0)); }
        }
