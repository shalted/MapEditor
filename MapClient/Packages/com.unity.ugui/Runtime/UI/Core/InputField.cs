...
namespace UnityEngine.UI
{
        ...
        ILayoutElement
    {
        ...
        protected virtual void ClampPos(ref int pos)
        {
            if (pos < 0) pos = 0;
        ...
        protected virtual int FindtNextWordBegin()
        {
        ...
        protected virtual int FindtPrevWordBegin()
        {
        ...
        /// </summary>
        protected virtual void SendOnSubmit()
        {
        ...
        public virtual void ActivateInputFieldInternal()
        {
