...
namespace TMPro.EditorUtilities
{
    ...
    {
        //SY Ext
        private static readonly GUIContent k_voffsetLabel = new GUIContent("Sprite Offset", "调整图片偏移");
        private static readonly GUIContent k_spriteAlignmentLabel = new GUIContent("Sprite Alignment", "图文混排对齐方式");
        private static readonly GUIContent k_alignSpriteLabel = new GUIContent("Auto Align Sprite", "图文混排自动水平居中对齐");
        //Labels and Tooltips
        ...
        static readonly GUIContent k_FontAssetKeyLabel = new GUIContent("Font Asset Key", "分离打包中记录的fontAssetKey");
        ...
        #region 图文混排水平居中对齐
        protected SerializedProperty m_voffsetProp;
        protected SerializedProperty m_alignSprite;
        protected SerializedProperty m_SpriteAlignmentOptProp;
        #endregion
        ...
        protected SerializedProperty m_FontAssetKeyProp;
        ...
        {
            m_voffsetProp = serializedObject.FindProperty("m_voffset");
            m_alignSprite = serializedObject.FindProperty("m_enableAutoAlignSprite");
            m_SpriteAlignmentOptProp = serializedObject.FindProperty("m_spriteAlignmentOpts");
            ...
            m_FontAssetKeyProp = serializedObject.FindProperty("fontAssetKey");
        ...
        private bool foldSpriteAlign = false;
        void DrawImgOffsetBar()
        {
            foldSpriteAlign = EditorGUILayout.BeginFoldoutHeaderGroup(foldSpriteAlign, "auto align sprite");
            if (foldSpriteAlign)
            {
                EditorGUILayout.PropertyField(m_voffsetProp, k_voffsetLabel, GUILayout.MaxWidth(EditorGUIUtility.labelWidth + 50f));
                EditorGUI.BeginChangeCheck();
                EditorGUILayout.PropertyField(m_SpriteAlignmentOptProp, k_spriteAlignmentLabel);
                EditorGUILayout.PropertyField(m_alignSprite, k_alignSpriteLabel);
                if (EditorGUI.EndChangeCheck())
                {
                    m_HavePropertiesChanged = true;
                }
        ...
        void DrawFont()
        {
            ...
            EditorGUILayout.PropertyField(m_FontAssetKeyProp, k_FontAssetKeyLabel);
