...
namespace TMPro
{
    ...
    public class TMP_Settings : ScriptableObject
    {
        ...
        /// </summary>
        public static event Func<TMP_Settings> OnSettingsRequest;
        public static TMP_Settings instance
        {
            get
            {
                if (TMP_Settings.s_Instance == null)
                {
                    ...
                    TMP_Settings.s_Instance = UnityEditor.AssetDatabase.LoadAssetAtPath<TMP_Settings>("Assets/Resources/TMPSettingsEditor.asset");
#endif

                    //TMP_Settings.s_Instance = OnSettingsRequest?.Invoke();

                    //                    TMP_Settings.s_Instance ??= Resources.Load<TMP_Settings>("TMP Settings");
                    //                    TMP_Settings.s_Instance ??= new TMP_Settings();
                    //#if UNITY_EDITOR
