...
namespace TMPro
{
    ...
    {
        public static event Action<TMP_SpriteAsset> OnEnableRequest;
        public static event Action<TMP_SpriteAsset> OnDisableRequest;
        ...
        public TMP_SpriteAsset spriteAsset
        {
            ...
            set
            {
                OnDisableRequest?.Invoke(m_spriteAsset);
                m_spriteAsset = value;
                OnEnableRequest?.Invoke(m_spriteAsset);
            }
        ...
        public static TMP_SubMeshUI AddSubTextObject(TextMeshProUGUI textComponent, MaterialReference materialReference)
        {
            ...
            OnEnableRequest?.Invoke(subMesh.m_spriteAsset);
