...
namespace TMPro
{
    ...
    public class TMP_SpriteAsset : TMP_Asset
    {
        ...
        public void SetTable(List<TMP_SpriteCharacter> spriteCharacters, List<TMP_SpriteGlyph> spriteGlyphTable, string version)
        {
            m_SpriteCharacterTable = spriteCharacters;
            m_SpriteGlyphTable = spriteGlyphTable;
