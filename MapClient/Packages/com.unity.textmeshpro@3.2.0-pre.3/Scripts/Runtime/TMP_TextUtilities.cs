...
namespace TMPro
{
    ...
    public static class TMP_TextUtilities
    {
        ...
        //{
        //    int index = TMP_TextUtilities.FindNearestCharacterInSameLine(textComponent, position, camera, false);
        ...
        /// <param name="visibleOnly">Only check for visible characters.</param>
        /// <returns></returns>
        //public static int FindNearestCharacterInSameLine(TextMeshProUGUI text, Vector3 position, Camera camera, bool visibleOnly)
        //{
        //    RectTransform rectTransform = text.rectTransform;
        ...
        /// <param name="visibleOnly">Only check for visible characters.</param>
        /// <returns></returns>
        //public static int FindNearestCharacterInSameLine(TextMeshPro text, Vector3 position, Camera camera, bool visibleOnly)
        //{
        //    Transform textTransform = text.transform;
